...
public class GravarProdutosUseCase : IUseCase<IEnumerable<GravarProdutosRequest>, GravarProdutosResponse>
{
    ...
    public async Task<GravarProdutosResponse> ExecuteAsync(IEnumerable<GravarProdutosRequest> request)
    {
        ...
        return new GravarProdutosResponse { Gravado = true};
    }
}
